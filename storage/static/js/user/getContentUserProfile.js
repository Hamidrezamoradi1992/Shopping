        document.addEventListener("DOMContentLoaded", (ev) => {
            ...
            fetch('user-profile', {
                ...
                console.log(contentUser.account.name)
                    elementsView.innerHTML = `<div class="bg-white rounded-lg shadow-xl pb-8">
            ...
            <div class="flex flex-col items-center -mt-20">
                <img src="${contentUser.account.picture }" class="w-40 border-4 border-white rounded-full">
                ...
                <div class="flex-1 bg-white rounded-lg shadow-xl p-8">
                    ...
                    <ul class="mt-2 text-gray-700">
                        <li class="flex border-y py-2">
                            ...
                            <span class="text-gray-700">${contentUser.account.name}</span>
                        </li>
                        ...
                        <li class="flex border-b py-2">
                            ...
                            <span class="text-gray-700">${contentUser.account.phone}</span>
                        </li>
                        <li class="flex border-b py-2">
                            <span class="font-bold w-24">Email:</span>
                            <span class="text-gray-700">${contentUser.user.email}</span>
                        </li>
                        <li class="flex border-b py-2">
